		...
		tab === 'session' ? (
			<div className="flex w-full max-w-xl flex-col gap-4">
				...
				<div
					...
					className="h-[56dvh] overflow-y-auto overscroll-contain rounded-3xl border border-white/30 bg-[var(--lilac-elevated)]/70 p-4 shadow-xl backdrop-blur"
				...
				<div className="rounded-3xl border border-white/25 bg-[var(--lilac-elevated)]/80 p-4 text-[var(--lilac-ink)] shadow-lg backdrop-blur">
					<div className="mb-2 font-semibold text-[10px] text-[var(--lilac-ink-muted)] uppercase tracking-[0.18em]">
						Text input
					</div>
